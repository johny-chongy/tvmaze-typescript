...
var DEFAULT_IMG_URL = "https://as2.ftcdn.net/v2/jpg/04/60/03/13/1000_F_460031310_ObbCLA1tKrqjsHa7je6G6BSa7iAYBANP.jpg";
...
function getShowsByTerm(term) {
    return __awaiter(this, void 0, void 0, function () {
        var showResponses, ShowInterfaces;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get("".concat(BASE_URL, "/search/shows?q=").concat(term))];
                case 1:
                    showResponses = _a.sent();
                    console.log("getrequest result: ", showResponses.data);
                    ShowInterfaces = showResponses.data.map(function (result) {
                        var _a;
                        return ({
                            id: result.show.id,
                            name: result.show.name,
                            summary: result.show.summary,
                            image: ((_a = result.show.image) === null || _a === void 0 ? void 0 : _a.medium) || DEFAULT_IMG_URL
                        });
                    });
                    return [2 /*return*/, ShowInterfaces];
            }
        });
    });
}
